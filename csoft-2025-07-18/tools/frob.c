/* $Id: frob.c,v 1.8 2021/04/21 12:01:34 alex Exp alex $ */
/*******************************************************************************
...
/* Open a temporary output file. */
    ...
    if ((fileName == NULL) || toStdout) {
        ...
        if (outFile == NULL) {
            perror ("tmpfile") ;
            PUSH_ERRNO ;
            fprintf (stderr, "On platforms that don't support tmpfile(3), use the \"-stdout\" option\n") ;
            fprintf (stderr, "and redirect standard output to a file.\n") ;
            POP_ERRNO ;
            exit (errno) ;
        }
    }
