/* $Id: ftpClient.c,v 1.7 2016/08/01 02:10:45 alex Exp alex $ */
/*******************************************************************************
...
Purpose:
    ...
    where:
        ...
        <dispatcher>	- I
            ...
            will be registered.
        <parameter>	- I
            is the possibly NULL, FTP data port service name, cast as a
            (VOID *) parameter.
        <client>	- O
...
/* Create an FTP session for the client. */
    ...
    if (nftCreate (connection, (const char *) parameter, NULL, NULL, NULL,
                   &session)) {
