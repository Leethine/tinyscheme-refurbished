/* $Id: fnm_util.h,v 1.12 2023/02/26 06:28:38 alex Exp alex $ */
/*******************************************************************************
...
typedef  enum  FnmPart {
    ...
    FnmVolume,				/* Volume name, if specified. */
...
extern  int  fnm_util_debug  OCD ("fnm_util") ;

/*******************************************************************************
    Public functions.
*******************************************************************************/

extern  char  *fnmBuild P_((FnmPart part,
                            const char *path,
                            ...))
    OCD ("fnm_util") ;
...
extern  char  *fnmEnv P_((const char *path,
                          ssize_t length))
    OCD ("fnm_util") ;

extern  bool  fnmExists P_((const char *path))
    OCD ("fnm_util") ;
...
extern  char  *fnmGetCWD P_((bool addSlash))
    OCD ("fnm_util") ;
