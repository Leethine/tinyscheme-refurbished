/* $Id: iel_util.h,v 1.2 2023/05/24 16:38:49 alex Exp $ */
...
/*******************************************************************************
    ...
    An alias, "LGT", is defined for LGI: "#define LGT LGI".  The 'T' stands
    for "temporary" or "testing" and, obviously, it functions exactly like
    LGI.  I use it for printf(3)-style debugging and the alternate name
    makes it easy to find and remove these statements after the debugging
    is complete.  NOTE that printf(3) statements always generate output,
    whereas the output of LGI/LGT statements depend on the defined
    conditional guards (see below).

    Error logging is accomplished with:
