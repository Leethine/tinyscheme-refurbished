/* $Id: lemx_idl.h,v 1.9 2021/09/15 04:18:16 alex Exp $ */
/*******************************************************************************
    ../idl/LECIS/LECIS.idl
*******************************************************************************/
/*  <stdin> : line 1  */
...
#ifndef IDL_MODULE_SCD
#    define  IDL_MODULE_SCD  1
#endif
...
#ifndef IDL_MODULE_SLM_INTERFACE
#    define  IDL_MODULE_SLM_INTERFACE  1
#endif
...
/*===== "ECommandType" already defined =====*/

/*===== "EVariableType" already defined =====*/
...
#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEAccessType P_((ComxChannel channel,
                                         EAccessType *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxECapacityType P_((ComxChannel channel,
                                           ECapacityType *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxECommandCategory P_((ComxChannel channel,
                                              ECommandCategory *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxECommandType P_((ComxChannel channel,
                                          ECommandType *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEComponentCategory P_((ComxChannel channel,
                                                EComponentCategory *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
    extern  errno_t  lemxEDataLinkType P_((ComxChannel channel,
                                           EDataLinkType *value))
        OCD ("SLM_INTE") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEDownTimeCategory P_((ComxChannel channel,
                                               EDownTimeCategory *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEDownTimeType P_((ComxChannel channel,
                                           EDownTimeType *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEEventCategory P_((ComxChannel channel,
                                            EEventCategory *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
    extern  errno_t  lemxEEventType P_((ComxChannel channel,
                                        EEventType *value))
        OCD ("SLM_INTE") ;
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
    extern  errno_t  lemxELocalRemote P_((ComxChannel channel,
                                          ELocalRemote *value))
        OCD ("SLM_INTE") ;
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
    extern  errno_t  lemxELocalRemote_ArgType P_((ComxChannel channel,
                                                  ELocalRemote_ArgType *value))
        OCD ("SLM_INTE") ;
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
    extern  errno_t  lemxEMainCtrlState P_((ComxChannel channel,
                                            EMainCtrlState *value))
        OCD ("SLM_INTE") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxENumberType P_((ComxChannel channel,
                                         ENumberType *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEOwnerstatus P_((ComxChannel channel,
                                          EOwnerstatus *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEPortType P_((ComxChannel channel,
                                       EPortType *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEResourceCategory P_((ComxChannel channel,
                                               EResourceCategory *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
    extern  errno_t  lemxEResultCode P_((ComxChannel channel,
                                         EResultCode *value))
        OCD ("SLM_INTE") ;
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
    extern  errno_t  lemxESubCtrlState P_((ComxChannel channel,
                                           ESubCtrlState *value))
        OCD ("SLM_INTE") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxESystemDomain P_((ComxChannel channel,
                                           ESystemDomain *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxETransferType P_((ComxChannel channel,
                                           ETransferType *value))
        OCD ("SCD") ;
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
    extern  errno_t  lemxEVariableType P_((ComxChannel channel,
                                           EVariableType *value))
        OCD ("SCD") ;
#endif
...
#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxICommand(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxIDownTime(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxIEvent(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxIExtMacroCommandList(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
#    define  lemxILECI(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxIPort(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxIResource(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxISCDRegistry(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxISLM(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxISubUnit(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxISystem(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
#    define  lemxITSC_Callback(channel,value)  gimxIOR ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxIWorkCell(channel,value)  gimxIOR ((channel), (value))
#endif
...
#if !defined(IDL_MODULE_SLM_INTERFACE) || IDL_MODULE_SLM_INTERFACE
#    define  lemxSeqOctet(channel,value)  comxOctetSeq ((channel), (value))
#endif

#if !defined(IDL_MODULE_SCD) || IDL_MODULE_SCD
#    define  lemxSeqString(channel,value)  comxStringSeq ((channel), (value))
#endif
