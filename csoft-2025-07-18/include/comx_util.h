/* $Id: comx_util.h,v 1.18 2023/05/24 16:36:33 alex Exp $ */
/*******************************************************************************
...
#else
#    define  LONGLONG  int64_t		/* GNU data types. */
#    define  ULONGLONG  uint64_t
#    define  LONGDOUBLE  long double
#endif

#ifndef TRUE				/* Allowed values for CORBA booleans. */
#    define  TRUE  1
#endif
#ifndef FALSE
#    define  FALSE  0
...
extern  size_t  comxSkip P_((ComxChannel channel,
                             size_t numOctets,
                             size_t alignment))
    OCD ("comx_uti") ;
