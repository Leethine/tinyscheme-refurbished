...
_OP_DEF(opexe_2, "big-add",                        2,  2,       TST_STRING,                      OP_ADD_BIG          )
_OP_DEF(opexe_2, "big-sub",                        2,  2,       TST_STRING,                      OP_SUB_BIG          )
_OP_DEF(opexe_2, "big-mul",                        2,  2,       TST_STRING,                      OP_MUL_BIG          )
_OP_DEF(opexe_2, "big-div",                        2,  2,       TST_STRING,                      OP_DIV_BIG          )
_OP_DEF(opexe_2, "big-mod",                        2,  2,       TST_STRING,                      OP_MOD_BIG          )
